        ...
        <div className="c-footer__grid">
          <div>
            ...
            <div className="c-footer__socials" aria-label="Réseaux sociaux">
              ...
              <a className="c-social-pill" href="https://wa.me/2250757249390?text=Bonjour%20Dav%20Consulting%2C%20je%20souhaite%20discuter%20d%27un%20projet%20digital" target="_blank" rel="noopener noreferrer" aria-label="WhatsApp" title="WhatsApp">
                <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
          ...
          <div>
            ...
            <ul>
              ...
              <li><a href="#design">Design & Identité Visuelle</a></li>
              <li><a href="#it">Infrastructure & Sécurité</a></li>
              <li><a href="#dev-process">Conseil digital</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul>
              ...
              <li className="c-contact-line">
                <PhoneIcon />
                <a href="tel:+2250758863765">+225 07 58 86 37 65</a>
              </li>
            </ul>
          </div>
        </div>
